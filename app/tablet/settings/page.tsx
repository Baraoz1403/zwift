  ...
  return (
    <div style={{ height: "100%", display: "flex", flexDirection: "column", background: "var(--m-bg)", overflow: "hidden" }}>
      ...
      <div style={{ padding: "14px 28px 10px", borderBottom: "1px solid var(--m-border)", background: "var(--m-card)", flexShrink: 0 }}>
        <div style={{ fontSize: 11, fontWeight: 700, color: "var(--m-muted)", textTransform: "uppercase", letterSpacing: ".12em" }}>Settings</div>
        <div style={{ fontSize: 14, color: "var(--m-muted)", marginTop: 2, fontWeight: 500 }}>Connections, appearance &amp; legal</div>
      </div>
      ...
      <div style={{ flex: 1, overflowY: "auto", overscrollBehavior: "contain", padding: "24px 28px" }}>
        ...
        <div style={{ background: "var(--m-card)", borderRadius: 14, border: "1px solid var(--m-border)", padding: "4px 0", marginBottom: 20 }}>
          <a href="/legal/terms" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 18px", textDecoration: "none", borderBottom: "1px solid var(--m-border)" }}>
            <div style={{ fontSize: 17, color: "var(--m-text)", fontWeight: 600 }}>Terms of Service</div>
            <ChevronRight />
          </a>
          <a href="/legal/privacy" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 18px", textDecoration: "none", borderBottom: "1px solid var(--m-border)" }}>
            <div style={{ fontSize: 17, color: "var(--m-text)", fontWeight: 600 }}>Privacy Policy</div>
            <ChevronRight />
          </a>
          <a href="/legal/disclaimer" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 18px", textDecoration: "none" }}>
            <div style={{ fontSize: 17, color: "var(--m-text)", fontWeight: 600 }}>Disclaimer</div>
            <ChevronRight />
          </a>
        </div>
