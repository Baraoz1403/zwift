...
return(
<div style={{width:"100%",maxWidth:1100,margin:"0 auto",boxSizing:"border-box",background:b.bg,borderRadius:16,padding:"40px 36px 32px",marginBottom:40,position:"relative",overflow:"hidden",border:"1px solid "+b.a+"20",boxShadow:"0 0 50px "+b.a+"12",fontFamily:"system-ui,sans-serif"}}>
