...
const ZONES = [
  { maxPct: 0.55, color: "#64748b", glow: "#94a3b8", label: "Z1 Recovery" },
  { maxPct: 0.75, color: "#3b82f6", glow: "#60a5fa", label: "Z2 Endurance" },
  { maxPct: 0.88, color: "#22d3ee", glow: "#67e8f9", label: "Z3 Tempo" },
  { maxPct: 0.94, color: "#10b981", glow: "#34d399", label: "Z4 Sweet Spot" },
  { maxPct: 1.05, color: "#f59e0b", glow: "#fbbf24", label: "Z5 Threshold" },
  { maxPct: 1.20, color: "#f97316", glow: "#fb923c", label: "Z6 VO2 Max" },
